...
private[fdb] object ExecutionState extends Enumeration {
  val STARTED, COMPILED, FAILED, CANCELED, FINISHED = Value
  type ExecutionState = Value
}

private[fdb] class ExecutionInfo(
...
private[fdb] class SQLServerListener(conf: SQLConf) extends SparkListener {
