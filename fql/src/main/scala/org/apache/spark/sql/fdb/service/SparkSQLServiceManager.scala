...
import org.apache.spark.sql.fdb.service.livy.{LivyProxyContext, LivyProxyExecutor, LivyServerService}
import org.apache.spark.sql.fdb.service.postgresql.{PgCatalogInitializer, PgCatalogUpdater, PgProtocolService, PgSessionInitializer}
import org.apache.spark.sql.fdb.ui.SQLServerTab
import org.apache.spark.sql.fdb.util.RecurringTimer
...
private[fdb] class SparkSQLServiceManager extends CompositeService with SessionService {
